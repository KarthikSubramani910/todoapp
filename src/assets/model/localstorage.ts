// AppService
export let studentDetails = [ {id:"1",name:"Karthik", gender:"Male",std:"12",status:"Pass"},
...
{id:"6", name:"Vignesh", gender:"Male",std:"12",status:"Pass"},
{id:"7", name:"Manish", gender:"Male",std:"10",status:"Fail"},
{id:"8", name:"Sarvesh", gender:"Male",std:"12",status:"Pass"},
{id:"9",name:"Gourav", gender:"Male",std:"10",status:"Fail"},
